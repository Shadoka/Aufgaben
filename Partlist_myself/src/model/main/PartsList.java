...
public class PartsList {
	...
	public void addPart(Component whole, ComponentCommon part, int amount) throws Exception {
	...
	public Vector<QuantifiedComponent> getMaterialList(Component component) {
		Materialmap c = component.getMaterialList();
		Vector<QuantifiedComponent> vectorList = new Vector<QuantifiedComponent>(c.values());
		return vectorList;
	}
